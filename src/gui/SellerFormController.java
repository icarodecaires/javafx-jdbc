...
public class SellerFormController implements Initializable {
	...
	public void onBtSaveAction(ActionEvent event) {
		if (entity == null) {
			throw new IllegalStateException("Entidade não pode ser nulo");
		}
	...
	private Seller getFormData() {
		...
		if (dpBirthDate.getValue() == null) {
			exception.addError("birthDate", "O Campo Nome Não Pode Ser Vazio");
		}else {
		...
		if (txtBaseSalary.getText() == null || txtBaseSalary.getText().trim().equals("")) {
			exception.addError("baseSalary", "O Campo Salário base Não Pode Ser Vazio");
		}
		
		obj.setBaseSalry(Utils.tryParseToDouble(txtBaseSalary.getText()));
	...
	public void loadAssociatedObjects() {
		if (departmentService == null) {
			throw new IllegalStateException("Dependencia ddepartamento não pode ser nulo");
		}
