...
public class SellerListController implements Initializable, DataChangeListener {
	...
	private void initializeNodes() {
		...
		// pegando uma referencia para stage atual
	...
	public void updateTableView() {
		...
		// Chama o método para criar o botão de edição nas linhas da tableview
		initEditButtons();
		//Cria o botão para deleção nas linhas da tableView
		initRemoveButtons();
	}
	...
	private void removeEntity(Seller obj) {
		...
		//Alert retorna o resultado do botão clicado
		Optional<ButtonType> result = Alerts.showConfirmation("Confirmação", "Deseja Realmente Deletar");
